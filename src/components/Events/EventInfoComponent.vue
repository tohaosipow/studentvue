        ...
        <v-card>
            ...
            <div v-if="event">
                ...
                <v-list-item>
                    ...
                    <v-list-item-subtitle class="text-right" v-if="event.u_place">{{event.u_place.name}}
                    </v-list-item-subtitle>
                    <v-list-item-subtitle class="text-right" v-else> Не указано
                    </v-list-item-subtitle>
                </v-list-item>
                <v-list-item>
                ...
                <v-list-item :key="role.id"
                             v-for="role in event.roles.filter((el) => {return parseInt(el.hidden) === 0})">
